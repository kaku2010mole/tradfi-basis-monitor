...
SYMBOLS = [
    ...
    for item in os.getenv(
        "FUTU_SYMBOLS",
        "HK.00388,HK.00625,HK.00700,HK.00992,HK.01024,HK.01211,HK.01810,HK.02097,HK.03690,HK.09988,HK.09992,HK.00100,HK.02513,HK.03308,HK.03986,HK.800000,HK.HSImain,US.LNVGY,US.BYDDY,US.NVDA",
    ).split(",")
    if item.strip()
]
